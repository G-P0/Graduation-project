    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo $rootpath; ?>/controllers/C_loginAndRegister.php">
                    <!--Email -->
        ...
        <div class="modal-footer">
            ...
            <div class="col">
                ...
                <a href="<?php echo $rootpath; ?>/signup.php">Register!</a>
            </div>
        ...
        <div class="row ">
            ...
            <div class=" brand col-4">
                <a class="navbar-brand" href="index.php">
                    <img src="<?php echo $rootpath; ?>/resources/images/logo1.png" alt="Logo" style="width:40px;">
                    <span>.</span>
            ...
            <div class=" logsys col-4 text-right">
                ...
                if (isset($_SESSION['username'])) {
                    ...
                    ?>
                    <a href="<?php echo $rootpath; ?>/logout.php" class="btn btn-primary btn-lg">Logout</a>
                    <a href="<?php echo $rootpath; ?>/controllers/C_actions.php?getPage=dashboard"
                       class="btn btn-success btn-lg">Control</a>
                    ...
                    <a href="<?php echo $rootpath; ?>/signup.php" class="btn btn-secondary btn-lg">Signup</a>
                    <?php
                }
                ?>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto ">
                ...
                <!--Dropdown list -->
                <li class="nav-item ">
                    <a class="nav-link" href="<?php echo $rootpath; ?>/services.php">Services</a>
                    <!--
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $rootpath; ?>/support.php">Support</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $rootpath; ?>/aboutus.php">About Us</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $rootpath; ?>/contactus.php">Contact Us</a>
                </li>
            </ul>
        </div>
    </div>
