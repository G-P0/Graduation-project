   ...
   <nav class="navbar navbar-expand-lg navbar-ligth  bg-dark">
	...
	<section class="services">
		<div class="container">
			...
			<hr>
			<div class="row" class="indoors">
				<div class="col-3">
					<div id="list-example" class="list-group">
					  <a class="list-group-item list-group-item-action" href="#list-item-1">Lighting Control</a>
					  <a class="list-group-item list-group-item-action" href="#list-item-2">Audio System Control</a>
					  <a class="list-group-item list-group-item-action" href="#list-item-3">Water System Control</a>
		   ...
		   <!--Outdoors -->
		   <h1>Outdoors Services</h1>
		   <hr>
			<div class="row" class="outdoors">
				<div class="col-3">
					<div id="list-example" class="list-group">
					  <a class="list-group-item list-group-item-action" href="#list-item-5">Gate Control</a>
					  <a class="list-group-item list-group-item-action" href="#list-item-6">Item6</a>
					  <a class="list-group-item list-group-item-action" href="#list-item-7">Item7</a>
