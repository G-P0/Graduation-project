        ...
        <form method="POST" action="controllers/C_loginAndRegister.php">
            ...
            <div class="form-row">
                ...
                <div class="col">
                    ...
                    <input type="password" class="form-control" id="inputConfirmation" placeholder="Password"
            ...
            <div class="form-group" style="margin-top: 20px; margin-bottom:0">
                ...
                <div class="custom-control custom-radio" style="margin: 5px 0">
                    <input type="radio" id="customRadio1" class="custom-control-input" name="gender" value="male"
                           required>
                    <label class="custom-control-label" for="customRadio1">Male</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" id="customRadio2" class="custom-control-input" name="gender" value="female"
                           required>
