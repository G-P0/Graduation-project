...
<head>
    ...
    <!-- Custom styles -->
    <link rel="stylesheet" type="text/css" href="../resources/css/explore.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
	  ...
	  <a class="navbar-brand" href="#">
          ...
          <span>.</span>
          <img src="../resources/images/logo5.png" alt="Logo" style="width:40px;">
          <span>.</span>    
          <img src="../resources/images/logo1.png" alt="Logo" style="width:40px;">
	  </a>
	  	<!--toggler -->
		...
		<div class="container-fluid">
		    ...
		    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			  ...
			  <div class="carousel-inner">
			    ...
			    <div class="carousel-item">
			      <img class="d-block w-100 " src="images/c3.jpg" alt="Third slide" style="width: 1300px ; height: 590px;">
			      <div class="carousel-caption d-none d-md-block">
				     <h5>What is Lorem Ipsum? </h5>
				    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic
				    </p>
		...
		<div class="container-fluid">
			...
			<div class="sentences">
				...
				<div>
					...
					<p>Our Home automation systems are so convenient to set-up that even a renter can have the assurance that their residence is secure with a top of the line system. Because of the convenient set-up, take down is just as easy. If you move homes, you can take your smart home system with you.
					</p>
				</div>
				<div>
...
<script src="../resources/script/smooth-scroll.min.js"></script>
